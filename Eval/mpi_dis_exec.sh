...
ssh aby31 "cd ./aby3/; mpirun -np "${tasks}" ./out/build/linux/frontend/frontend -prog -1 -role 1 ${args_list}" &
ssh aby32 "cd ./aby3/; mpirun -np "${tasks}" ./out/build/linux/frontend/frontend -prog -1 -role 2 ${args_list}" &
wait;
