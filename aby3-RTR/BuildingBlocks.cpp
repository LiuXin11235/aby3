...
// int cipher_mul(u64 pIdx, si64Matrix &sharedA, si64Matrix &sharedB, si64Matrix &res, Sh3Evaluator &eval, Sh3Runtime &runtime){
...
//   // Sh3Task binTask = runtime.noDependencies();
